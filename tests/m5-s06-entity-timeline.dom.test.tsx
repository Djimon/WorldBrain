...
vi.mock('../src/services/event-service', () => ({
  listEvents: vi.fn(async (_db: unknown, { participantId, locationId }: { participantId?: string; locationId?: string }) => {
    const all = [
...
describe('M5-S06 entity timeline views', () => {
  ...
  describe('Location Timeline', () => {
    ...
    it('shows only events at the location', async () => {
