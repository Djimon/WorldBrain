...
export const CORE_ICON_SET: IconSet = {
  ...
  icons: [
    ...
    { key: 'stunned', label: 'Stunned', svg: SVG('<g transform="rotate(45 12 12)"><path d="M12 12c.6 0 1-.5 1-1s-.6-1.4-1.5-1.4-2 1-2 2.4 1.3 2.9 3 2.9 3.6-1.6 3.6-3.9-2-4.4-4.5-4.4S6 8.6 6 12"/></g>') },
    ...
    { key: 'on-fire', label: 'On Fire', svg: SVG('<g transform="translate(12 12) scale(1.18) translate(-12 -12)"><path d="M12 3c1 3 4 4 4 8a4 4 0 0 1-8 0c0-1.8.9-2.6 1.6-3.4.4 1 1.4 1.4 1.4 1.4C11.6 7 11 5 12 3Z"/></g>') },
